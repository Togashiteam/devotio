// contracts/community.ts
// TypeScript type contracts for Community entities.
// Governs src/data/community-feed.json, src/data/events.json,
// and the communityStore session state.
...
export interface CommunityStore {
  ...
  unhideItem: (id: string) => void;   // undo affordance
